...
//             inequality
//
// If the tableau is rational then none of the special cases apply and we return
// SEPARATE.
//
...
bool Simplex::rowIsAtLeastZero(Unknown &unknown) {
  assert(unknown.ownsRow && "Unknown is in column position!");
