...
// TEST(IntegerPolyhedronTest, intBenchmark) {
//   int64_t x = a, y = b;
//   auto total = x;
...
// TEST(IntegerPolyhedronTest, dynIntBenchmark) {
//   DynamicAPInt x(a), y(b);
//   auto total = x;
//   for (int i = 4; i <= 100000000; ++i) {
//     total = (total*x)*i;
//     total = (total - x / c) % y;
...
// TEST(IntegerPolyhedronTest, APIntBenchmark) {
//   APInt x(64, a), y(64, b);
//   auto total = x;
//   for (int i = 4; i <= 100000000; ++i) {
//     total = (total*x)*i;
//     total = (total - x.sdiv(c)).srem(y);
//     total = (total + d*x).srem(y);
//   }
//   llvm::errs() << total << '\n';
// }

// TEST(IntegerPolyhedronTest, intGcd) {
//   int64_t x(a), y(b), z(c), w(d);
//   for (int i = 1; i <= 10000000; ++i) {
//     x = x + std::gcd(std::gcd(x, y), std::gcd(z, w));
//   }
//   llvm::errs() << x << '\n';
// }

// TEST(IntegerPolyhedronTest, dynGcd) {
//   DynamicAPInt x(a), y(b), z(c), w(d);
//   for (int i = 1; i <= 10000000; ++i) {
//     x = x + llvm::gcd(llvm::gcd(x, y), llvm::gcd(z, w));
//   }
//   x.dump();
// }
